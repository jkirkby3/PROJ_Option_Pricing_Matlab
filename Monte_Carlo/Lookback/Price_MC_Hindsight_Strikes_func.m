...
% NOTE: for hinsight options (fixed strike), returns an array of prices (or a single price if the length of strikes is 1)
%     : for lookback options (floating strike), returns a single price
%
